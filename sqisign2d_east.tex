...
\newcommand{\myemph}[1]{\textcolor{magenta}{\emph{#1}}} % Emphasize
...
\section{Overview of SQIsign2D-East}
\begin{frame}[plain, noframenumbering]
    \tableofcontents[currentsection]
\end{frame}
\input{overview.tex}

\section{How to compute the auxiliary isogeny}
\begin{frame}[plain, noframenumbering]
    \tableofcontents[currentsection]
\end{frame}
